        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
              ...
              {/* Left Column: Image */}
              <Reveal animation="fade-in-left" className="lg:col-span-6">
              ...
              <Reveal animation="fade-in-right" className="lg:col-span-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {values.map((val, index) => (
                <Reveal key={index} animation="scale-in" delay={index * 120} className="h-full flex flex-col">
                  <div
                    className="bg-white border border-gray-100 rounded-3xl p-8 shadow-sm flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-6 h-full"
                  >
